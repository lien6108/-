      ...
      if (s.maps_url) {
        return {
          ...
          contents: [
            ...
            { type: 'button', action: { type: 'uri', label: '導航', uri: s.maps_url }, style: 'secondary', height: 'sm', flex: 2 },
            { type: 'button', action: { type: 'postback', label: '刪除', data: `cmd=刪除景點 #${s.id}` }, style: 'secondary', height: 'sm', flex: 2 }
          ]
        };
      }
      return {
